...
import pandas as pd
from Ichimoku4 import Ichimoku4_Strategy
#%% functions
def prepare_df(df):
...
cash = 1_000_000_000
bt = Backtest(df, Ichimoku4_Strategy,
              cash=cash,
              trade_on_close=True,
...
param_grid = {
    "s": [9] + [5, 8, 11, 14, 17],
    "m": list(range(10, 42+1, 4)),
    "l": list(range(20, 80+1, 4)),
    "exit_high_n": [2, 3, 4, 5],
}
...
stats = bt.run(s = 17, m = 30, l = 32, exit_high_n = 2)
